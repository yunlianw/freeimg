    ...
    'cos' => [
        ...
        'fields' => [
            'endpoint' => ['label' => 'Endpoint', 'type' => 'text', 'required' => true,
                ...
                'help' => "⚠️ 智能解析：以下格式都自动识别\n✅ cos.ap-guangzhou.myqcloud.com\n✅ https://cos.ap-guangzhou.myqcloud.com\n✅ mybucket-1250000000.cos.ap-guangzhou.myqcloud.com（自动去桶名前缀）\n❌ 不要带路径（/storage），如有只取域名"],
            'region' => ['label' => 'Region 区域', 'type' => 'text', 'required' => true,
                'placeholder' => '如 ap-guangzhou',
                'help' => '⚠️ 必须从 Endpoint 截取保持一致（ap-guangzhou / ap-beijing-1 / ap-shanghai 等），错一位就 403 SignatureDoesNotMatch。注意 ap-beijing-1 的 1 是真实的，不是笔误。'],
            'bucket' => ['label' => 'Bucket 名称', 'type' => 'text', 'required' => true,
    ...
    'obs' => [
        ...
        'fields' => [
            'endpoint' => ['label' => 'Endpoint', 'type' => 'text', 'required' => true,
                ...
                'help' => "⚠️ 智能解析：以下格式都自动识别\n✅ obs.cn-north-4.myhuaweicloud.com\n✅ https://obs.cn-north-4.myhuaweicloud.com\n❌ 不要带桶名（控制台给的 endpoint 就是裸域名，不含桶名）"],
