...
<form method="POST" action="<?= base_url('settings') ?>" class="settings-form" enctype="multipart/form-data">
    ...
    <div class="field-group">
        ...
        <div class="form-group">
            <label>水印文字</label>
            <input type="text" name="watermark_text" value="<?= htmlspecialchars($settings['watermark_text'] ?? '') ?>" placeholder="如：© pic.5276.net">
    ...
    <div class="field-group">
        ...
        <div class="form-group">
            ...
            <div class="hint">
                ...
                示例：<code>rest/new</code> → <code>https://pic.5276.net/uploads/rest/new/abc123.jpg</code><br>
