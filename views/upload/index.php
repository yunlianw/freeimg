        ...
        <div class="config-grid">
            ...
            <div class="config-item">
                ...
                <select name="quality" id="quality-select" class="config-input">
                    <option value="original">原图（不压缩）</option>
                    <option value="high">高清 (2048px / 0.85)</option>
                    <option value="balanced" selected>⭐ 均衡 (1600px / 0.70) · ≤2MB</option>
                    <option value="saver">省流 (1200px / 0.55) · ≤1MB</option>
                    <option value="extreme">极限省流 (900px / 0.40) · ≤0.5MB</option>
                </select>
                <div class="config-hint">默认均衡档，目标 20-100KB</div>
            </div>
