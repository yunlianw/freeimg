...
<div class="image-detail">
    ...
    <div class="card">
        ...
        <div class="detail-meta">
            ...
            <div><strong><?= number_format($image['final_size'] / 1024, 2) ?> KB</strong>（原 <?= number_format($image['original_size'] / 1024, 2) ?> KB）</div>
            <div><strong style="color:var(--green-500);">↓ <?= round((1 - $image['compression_ratio']) * 100, 1) ?>%</strong>节省</div>
            <div><strong><?= htmlspecialchars($image['mime_type']) ?></strong></div>
