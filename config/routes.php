...
$router->post('/api/v1/upload', [\App\Controllers\ApiKeyController::class, 'apiUpload']);
$router->get('/api/v1/upload', function () { (new \App\Controllers\ApiKeyController())->apiUploadInfo(); });
